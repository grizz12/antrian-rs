...
@section('content')
 ...
 <div class="container"> 
  <img src="images/Poster2.png" alt="Lights" style="width:100%;">
  <hr>  
  <br><br>
      ...
      <div class="row justify-content-center">
        <div class="col-md-11">
          <div class="clearfix">
            ...
            <img src="images/Politeknik_Piksi_Ganesha_Bandung.png" class="col-md-2 float-md-end mb-3 ms-md-3" alt="Logo Piksi Ganesha" >
                <h1><b>Halo,</b></h1>
                <p>Selamat Datang Di Website Kami Klinik Sederhana.
                    Disini Kami Berkolaborasi Antara SMK ASSALAAM Dengan
                    Politeknik Piksi Ganesha.Website Ini Berisi Tentang Pemesanan Tiket Secara Online Untuk Pasien Yang 
                    Ingin Mendaftar Berobat di <b>Klinik</b><small>Sederhana</small>.Daftar Terlebih Dahulu Untuk Memesan Tiket!
                </p>
      ...
      <div class="row g-0 bg-white  position-relative">
        ...
        <div class="col-md-8">
          ...
          <a href="https://www.piksi.ac.id/" class="stretched-link">INFORMASI SELENGKAPNYA</a>
        </div>
      </div>
      <br><br><br><br><br>
        <div class="row justify-content-center">
          <p align="center" style="font-size: 50px"><b>INFORMASI DATA PASIEN</b></p>
          <br><br><br>
            <div class="col-md-11">
              ...
              <div class="row">
                ...
                <div class="col-lg-6 col-6">
                  <!-- small box -->
                  <div class="small-box  text-white" style="background-color: dodgerblue">
                    <div class="inner">
                      <h3>{{ $tiket }}</h3>
                      <p>Daftar Data Pasien yang Kunjungan Pasien & Tiket</p>
                    </div>
                      <div class="icon">
...
{{-- <div class="clearfix">
  ...
  <img src="images/Politeknik_Piksi_Ganesha_Bandung.png" class="col-md-2 float-md-end mb-3 ms-md-3" alt="Logo Piksi Ganesha" >
      <h1><b>Hi,</b></h1>
      <p>Selamat Datang Di Website Kami Klinik Sederhana.
          Disini Kami Berkolaborasi Antara SMK ASSALAAM Bersama
          Politeknik Piksi Ganesha.Pemesanan tiket online untuk pasien yang 
          ingin berobat.Daftar Terlebih Dahulu Untuk Memesan Tiket
      </p>
      <a href="{{ route('data_pasien.create') }}" class="btn btn-dark" style="float: left">Daftar Pasien</a>
      <br>
</div> --}}
