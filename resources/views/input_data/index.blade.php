    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <a href="{{ route('input_data.create') }}"
                        class="btn btn-lg btn-primary " style="float: left;">
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-plus-square-fill" viewBox="0 0 16 16">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($input_data as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->pasien_datang }}</td>          
                                            <td>{{ $data->nama_dokter }}</td>
                                            <td>{{ $data->diagnosa }}</td>
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                <form action="{{ route('input_data.destroy', $data->id) }}" method="post">
                                                    @method('delete')
                                                    @csrf
                                                    <a href="{{ route('input_data.edit', $data->id) }}"
                                                    ...
                                                    <a href="{{ route('input_data.show', $data->id) }}"
